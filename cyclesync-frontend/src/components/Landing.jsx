        ...
        <Container maxW="container.xl">
          <VStack spacing={6} textAlign="center">
            ...
            <Text fontSize={{ base: 'lg', md: 'xl' }} color={textColor} maxW="2xl">
              CycleSyNC helps you understand your menstrual cycle, log symptoms, and predict your next period with confidence.
            </Text>
            <HStack spacing={4}>
              <MotionButton
                as={Link}
        ...
        <Container maxW="container.lg">
          <VStack spacing={6} textAlign="center">
            ...
            <Text fontSize="lg" color={textColor} maxW="2xl">
              At CycleSyNC, we empower you to take control of your reproductive health with a user-friendly platform that combines science and simplicity.
            </Text>
          </VStack>
        </Container>
      </MotionBox>
            ...
            <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
              {[
                ...
                <MotionBox
                  ...
                  transition={{ delay: index * 0.2, duration: 0.5 }}
                >
                  <Text color={textColor} mb={4}>"{testimonial.quote}"</Text>
                  <Text fontWeight="bold" color="brand.500">— {testimonial.name}</Text>
                </MotionBox>
              ))}
            </SimpleGrid>
          </VStack>
